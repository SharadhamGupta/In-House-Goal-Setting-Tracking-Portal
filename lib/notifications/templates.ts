...
export function buildWorkflowEmail(input: WorkflowEmail) {
  ...
  const overflow = input.goals.length > 6 ? `<p style="margin:12px 0 0;color:#64748b;font-size:13px;">+${input.goals.length - 6} more goals in AtomBerg GoalHub.</p>` : "";
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:16px 28px;background:#f8fafc;color:#64748b;font-size:12px;">
                    AtomBerg GoalHub automated notification. Microsoft Teams delivery can be added later from the same event stream.
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td align="center">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:16px 28px;background:#f8fafc;color:#64748b;font-size:12px;">
                    AtomBerg GoalHub governance alert. This escalation was generated by rule-based compliance checks.
                  </td>
                </tr>
              </table>
            </td>
...
export function buildCheckInWindowOpenEmail(recipientName: string, quarter: string, closeDate: string, ctaHref: string) {
  return `
    <!doctype html>
    <html>
      <body style="margin:0;background:#f8fafc;font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
          ...
          <tr>
            <td align="center">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;">
                <tr>
                  <td style="padding:24px 28px;background:#0f172a;color:#ffffff;">
                    <div style="font-size:12px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#67e8f9;">Window Opened</div>
                    <h1 style="margin:8px 0 0;font-size:24px;line-height:1.2;">${escapeHtml(quarter)} Check-in Window Open</h1>
                  </td>
                </tr>
                <tr>
                  <td style="padding:28px;">
                    <p style="margin:0 0 14px;font-size:15px;line-height:1.6;">Hi ${escapeHtml(recipientName)},</p>
                    <p style="margin:0 0 18px;font-size:15px;line-height:1.6;">The ${escapeHtml(quarter)} check-in window is now open.</p>
                    <p style="margin:0 0 18px;font-size:15px;line-height:1.6;font-weight:bold;color:#b91c1c;">Window closes: ${escapeHtml(closeDate)}.</p>
                    <p style="margin:0 0 18px;font-size:15px;line-height:1.6;">Please log in to update your achievement progress.</p>
                    <a href="${escapeHtml(ctaHref)}" style="display:inline-block;margin-top:6px;border-radius:10px;background:#0891b2;color:#ffffff;padding:12px 18px;text-decoration:none;font-weight:700;">Open GoalHub</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:16px 28px;background:#f8fafc;color:#64748b;font-size:12px;">
