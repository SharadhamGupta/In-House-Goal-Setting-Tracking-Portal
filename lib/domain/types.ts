...
export interface AchievementUpdate {
  ...
  syncedFromOwner?: boolean;
  managerCheckinCompleted?: boolean;
  managerCheckinCompletedAt?: string | null;
  createdAt: string;
  updatedAt: string;
}
...
export interface GoalCycle {
  ...
  goalSettingClosesAt: string;
  q1OpensAt: string; q1ClosesAt: string;
  q2OpensAt: string; q2ClosesAt: string;
  q3OpensAt: string; q3ClosesAt: string;
  q4OpensAt: string; q4ClosesAt: string;
  isActive: boolean;
  createdAt: string;
}
