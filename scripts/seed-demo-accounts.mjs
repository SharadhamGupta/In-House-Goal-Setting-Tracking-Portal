...
async function seedDemoWorkspace() {
  ...
  const achievements = [
    achievement("44444444-4444-4444-8444-444444444441", "11111111-1111-4111-8111-111111111111", employeeId, "Q1", "14%", "on_track", 78, "Strategic account pipeline moved faster.", "Focus on two late-stage renewals."),
    achievement("44444444-4444-4444-8444-444444444442", "11111111-1111-4111-8111-111111111112", employeeId, "Q2", "22 hours", "completed", 100, "Queue triage reduced handoffs.", "Document the triage pattern."),
    achievement("44444444-4444-4444-8444-444444444443", "11111111-1111-4111-8111-111111111113", employeeId, "Q3", "0", "completed", 100, "No Sev-1 incidents.", "Keep prevention checklist active."),
    achievement("44444444-4444-4444-8444-444444444444", "11111111-1111-4111-8111-111111111114", employeeId, "Q4", "96%", "on_track", 96, "Final assessment scheduled.", "Close final module this week."),
    achievement("44444444-4444-4444-8444-444444444445", "11111111-1111-4111-8111-111111111118", rohanId, "Q1", "88%", "on_track", 96, "Weekend backlog needs focus.", "Review staffing for weekend queues."),
    achievement("44444444-4444-4444-8444-444444444446", "11111111-1111-4111-8111-111111111119", rohanId, "Q2", "48 tickets", "on_track", 83, "Repeat complaints trending down.", "Add root-cause tags."),
    achievement("44444444-4444-4444-8444-444444444447", "11111111-1111-4111-8111-111111111121", priyaId, "Q1", "132 leads", "completed", 100, "Campaign optimization improved quality.", "Strong delivery."),
    achievement("44444444-4444-4444-8444-444444444448", "11111111-1111-4111-8111-111111111122", priyaId, "Q2", "100%", "completed", 100, "Training certification completed.", "Completed on time.")
  ];
...
function achievement(id, goalId, employeeId, quarter, actualValue, status, progressPercent, employeeComment, managerComment) {
  return {
    id,
    goal_id: goalId,
    employee_id: employeeId,
